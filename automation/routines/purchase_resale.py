...
class PurchaseResaleManifestation:
    ...
    """
    def __init__(self, page, toolbox, logger, validator, data, db, parameters):
        self.page = page
...
class PurchaseResaleLauncher:
    def __init__(self, page, toolbox, logger, data, dir_logs, db, parameters, navigator=None):
    ...
    def launch(self, page: object, operation: str, checker: str, vendor: str, payment_policy: str, cost_center: str):
    ...
    def taxes(self, page: object) -> None:
        ...
        try:
            ...
            if not self._verify_error(page):
    ...
    def _verify_error(self, page: object) -> bool:
